...
function getFormValue(e){
    e.preventDefault();
    const getCityName=document.getElementById("myInput").value;
    console.log(getCityName);
    const url = `https://api.openweathermap.org/data/2.5/weather?q=${getCityName}&appid=3378232ecde9e975edb427f14dd39fc8
    `;
    //api calling
